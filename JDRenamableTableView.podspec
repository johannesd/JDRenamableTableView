...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   This repo offers you a TableView and TableViewCells which allow the user to rename the elements.

                   * Use JDRenamableTableView just like UITableView
                   * Use JDRenamableTableViewCell instead of UITableViewCell
                   DESC

  s.homepage     = "https://github.com/johannesd/JDRenamableTableView"
